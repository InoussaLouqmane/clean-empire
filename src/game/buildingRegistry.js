...
const NAMES = {
  ...
  building_ecole: ['École Les Petits Génies', 'Collège du Littoral', 'École Primaire Akpakpa'],
  building_marche: ['Marché du Quartier', 'Marché aux Fruits', 'Marché Central', 'Petit Marché du Port'],
  building_hotel: [
    'Hôtel du Lac',
    'Hôtel Palmier Bleu',
    'Hôtel La Marina',
  ...
  building_cinema: ['Ciné Étoile', 'Ciné Lumière', 'Ciné Le Rex', 'Ciné Palace', 'Ciné Océan'],
  building_hopital: ["Hôpital de la Mère et de l'Enfant", 'Clinique Saint-Luc'],
  building_depot: ['Déchetterie municipale', 'Centre de tri du Port'],
